      ...
      <div className="bg-white rounded-3xl p-4 border border-stone-200/80 shadow-sm flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-black rounded-xl text-xs flex items-center gap-1.5 shadow-md shadow-purple-500/20 transition-all transform active:scale-95"
          >
        ...
        {activities.map((act) => {
          ...
          return (
            <div key={act.id} className="flex items-start gap-4 relative z-10 group">
              ...
              {/* Main Activity Card */}
              <div 
                className={`flex-1 bg-white rounded-2xl p-4 border border-stone-200/80 shadow-sm border-l-4 ${getCategoryColor(act.category)} transition-all hover:border-purple-300 hover:shadow-md`}
              >
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    {act.hasAttachment && (
                      <button
                        ...
                        className="flex items-center gap-1 px-2 py-1 bg-purple-50 hover:bg-purple-100 text-purple-700 text-[11px] font-bold rounded-lg border border-purple-200/80 transition-colors"
                      >
                    ...
                    {act.locationName && (
                      <div className="w-7 h-7 rounded-lg bg-stone-100 hover:bg-purple-50 text-stone-500 hover:text-purple-600 flex items-center justify-center transition-colors">
