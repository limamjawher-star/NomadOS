    ...
    <div id="nomados-landing-page" className="min-h-screen bg-[#fafaf9] text-stone-900 selection:bg-orange-600 selection:text-white">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-stone-200/80 px-4 sm:px-8 py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            onClick={onOpenAuth}
            className="px-3 sm:px-4 py-2 text-xs font-bold text-stone-700 hover:text-stone-900 hover:bg-stone-100 rounded-full transition-colors"
          >
            Sign in
          </button>
          <button
      ...
      <section className="pt-12 sm:pt-20 pb-16 px-4 sm:px-8 max-w-6xl mx-auto text-center space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          ...
          <button
            ...
            className="px-6 py-3.5 bg-white hover:bg-stone-50 border border-stone-200 text-stone-800 font-extrabold text-sm rounded-full shadow-sm flex items-center gap-2 transition-all"
          >
        ...
        <div className="relative pt-6 max-w-xl mx-auto">
          ...
          <div className="bg-white rounded-[2.5rem] p-4 sm:p-5 border-4 border-stone-800/90 shadow-2xl relative text-left">
            {/* Status bar */}
            ...
            <div className="pt-4 max-h-[540px] overflow-y-auto no-scrollbar space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="bg-stone-50 rounded-2xl p-3 border border-stone-200 flex flex-col justify-between h-24">
                      ...
                      <div>
                        <h4 className="font-extrabold text-stone-900 text-sm">Bali</h4>
                        <p className="text-[11px] text-stone-400">Indonesia</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2.5 rounded-xl bg-rose-50 border border-rose-200 flex items-center gap-2 text-xs">
                      <span className="px-1.5 py-0.5 bg-rose-600 text-white rounded text-[10px] font-black">
                        ACTION
                      </span>
              ...
              {activeFeatureTab === 'visas' && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="font-black text-sm text-stone-900">Visas & Documents</h4>
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center text-xs">
                    ...
                    <div className="p-2 bg-emerald-50 rounded-xl border border-emerald-200">
                      <span className="text-stone-500 text-[10px] block">Overstay</span>
                      <span className="font-black text-emerald-700 text-sm">0</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-stone-50 rounded-2xl p-3 border border-stone-200 space-y-1.5">
                    ...
                    <p className="text-xs font-extrabold text-emerald-600">80 D left · 10/90 used</p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="p-3 bg-stone-50 rounded-xl border border-stone-200">
                      <span className="text-[10px] text-stone-400 block font-bold">TRIP TOTAL</span>
                      <span className="text-base font-black text-stone-900">€1,890</span>
                      <span className="text-[10px] text-stone-500 block">12 expenses</span>
                    </div>
                    <div className="p-3 bg-stone-50 rounded-xl border border-stone-200">
                      <span className="text-[10px] text-stone-400 block font-bold">THIS MONTH</span>
                      <span className="text-base font-black text-stone-900">€1,420</span>
                      <span className="text-[10px] text-stone-500 block">7 expenses</span>
                    </div>
                  </div>
                  <div className="p-3 bg-white rounded-xl border border-stone-200 space-y-2 text-xs">
                    <div className="flex items-center justify-between">
                      <span className="font-bold">Flight to BKK · Bangkok</span>
                      <span className="font-black text-stone-900">$850</span>
                    </div>
                    <div className="flex items-center justify-between text-stone-500">
                      <span>Pasta Trastevere · Rome</span>
                      <span className="font-bold text-stone-800">€38</span>
                    </div>
                    <div className="flex items-center justify-between text-stone-500">
                      <span>Apartment 5 nights · Rome</span>
                      <span className="font-bold text-stone-800">€420</span>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="bg-stone-50 rounded-3xl p-6 border border-stone-200 shadow-sm space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm">
                <span className="text-xs font-bold text-stone-400 block">LOCATION</span>
                <h4 className="text-lg font-black text-stone-900 mt-1">Bali, Indonesia</h4>
                <span className="text-xs text-stone-400">Asia / Jakarta</span>
              </div>
              <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm">
              ...
              <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm">
                ...
                <h4 className="text-lg font-black text-rose-600 mt-1">13 days left</h4>
                <span className="text-xs text-stone-400">e-Visa 90d</span>
              </div>
              <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="order-2 md:order-1 bg-white rounded-3xl p-6 border border-stone-200 shadow-sm space-y-4">
            ...
            <div className="space-y-2 pt-1">
              <div className="p-3 bg-stone-50 rounded-2xl border border-stone-200 flex items-center justify-between">
                <div>
                  <h5 className="font-black text-xs text-stone-900">Indonesia Visa on Arrival (B213)</h5>
                  <p className="text-[11px] text-stone-500">Entry: Apr 06 · 28/30 days used</p>
                </div>
                <span className="text-[10px] font-extrabold text-rose-600 bg-rose-100 px-2 py-1 rounded-md">
                  Extend / Exit
                </span>
              </div>
              ...
              <div className="p-3 bg-stone-50 rounded-2xl border border-stone-200 flex items-center justify-between">
                <div>
                  <h5 className="font-black text-xs text-stone-900">Thailand Visa Exemption</h5>
                  <p className="text-[11px] text-stone-500">Tourist 30-day waiver · Ready</p>
                </div>
                <span className="text-[10px] font-extrabold text-emerald-600 bg-emerald-100 px-2 py-1 rounded-md">
                  Active
                </span>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
              <span className="px-3 py-1 bg-stone-100 rounded-full text-xs font-bold text-stone-700">• Multi-country itineraries</span>
              <span className="px-3 py-1 bg-stone-100 rounded-full text-xs font-bold text-stone-700">• Per-stop budgets</span>
              <span className="px-3 py-1 bg-stone-100 rounded-full text-xs font-bold text-stone-700">• Collaborative planning</span>
              <span className="px-3 py-1 bg-stone-100 rounded-full text-xs font-bold text-stone-700">• Visa requirements auto-loaded</span>
            </div>
          </div>

          {/* Interactive Multi-Stop Trip View Component */}
          <div className="bg-[#fafaf9] rounded-3xl p-6 border border-stone-200/90 shadow-sm max-w-3xl mx-auto">
            <MultiStopTripView />
          </div>
        </div>
      </section>
      ...
      <section id="section-daily" className="py-16 px-4 sm:px-8 border-t border-stone-200/80 bg-[#fafaf9]">
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• AI-generated day plans</span>
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• Custom daily schedule</span>
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• Attach documents</span>
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• Maps pin per activity</span>
            </div>
          </div>

          <div className="bg-white rounded-3xl p-6 border border-stone-200 shadow-sm max-w-2xl mx-auto">
            <DayItineraryView activities={state.dayActivities || []} />
          </div>
        </div>
      </section>
      ...
      <section id="section-expenses" className="py-16 px-4 sm:px-8 border-t border-stone-200/80 bg-white">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="bg-stone-50 rounded-3xl p-6 border border-stone-200 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm">
                <span className="text-[10px] font-extrabold text-stone-400 block">TRIP TOTAL</span>
                <h4 className="text-xl font-black text-stone-900 mt-1">€1,890</h4>
                <span className="text-xs text-stone-400">12 expenses</span>
              </div>
              <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm">
                <span className="text-[10px] font-extrabold text-stone-400 block">THIS MONTH</span>
                <h4 className="text-xl font-black text-stone-900 mt-1">€1,420</h4>
                <span className="text-xs text-stone-400">7 expenses</span>
              </div>
            </div>

            <div className="bg-white p-4 rounded-2xl border border-stone-200 shadow-sm space-y-3">
              <span className="text-xs font-black text-stone-700 block">Recent Expenses</span>
              <div className="space-y-2 text-xs">
                <div className="flex items-center justify-between pb-2 border-b border-stone-100">
                  <div>
                    <h5 className="font-extrabold text-stone-900">Flight to BKK</h5>
                    <p className="text-[11px] text-stone-400">Bangkok · Transport</p>
                  </div>
                  <span className="font-black text-stone-900">$850</span>
                </div>
                <div className="flex items-center justify-between pb-2 border-b border-stone-100">
                  <div>
                    <h5 className="font-extrabold text-stone-900">Pasta Trastevere</h5>
                    <p className="text-[11px] text-stone-400">Rome · Food & Dining</p>
                  </div>
                  <span className="font-black text-stone-900">€38</span>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <h5 className="font-extrabold text-stone-900">Apartment 5 nights</h5>
                    <p className="text-[11px] text-stone-400">Rome · Housing</p>
                  </div>
                  <span className="font-black text-stone-900">€420</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="section-community" className="py-16 px-4 sm:px-8 border-t border-stone-200/80 bg-[#fafaf9]">
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• Nomads near you</span>
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• Local meetups & events</span>
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• Community feed</span>
              <span className="px-3 py-1 bg-white border border-stone-200 rounded-full text-xs font-bold text-stone-700 shadow-sm">• Direct messaging</span>
            </div>
          </div>
      ...
      <footer className="py-12 px-4 sm:px-8 bg-white border-t border-stone-200 text-stone-500 text-xs">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-6 font-semibold">
            <button onClick={() => onLaunchApp('home')} className="hover:text-stone-900">Command Center</button>
            <button onClick={() => onLaunchApp('travel')} className="hover:text-stone-900">Visa Vault</button>
            <button onClick={() => onLaunchApp('explore')} className="hover:text-stone-900">Explore Cities</button>
            <button onClick={() => onLaunchApp('social')} className="hover:text-stone-900">Community Map</button>
            <button onClick={onOpenPricing} className="hover:text-stone-900">Pro Pricing</button>
          </div>
