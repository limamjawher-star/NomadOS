      ...
      >
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-2">
          <div className="flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-xl bg-orange-500 text-white font-black text-xs shadow-md shadow-orange-500/25">
        ...
        <div className="p-6 overflow-y-auto space-y-5 flex-1">
          ...
          <div className="flex flex-col items-center text-center space-y-2">
            <div className="w-14 h-14 rounded-2xl bg-orange-500 flex items-center justify-center text-white shadow-xl shadow-orange-500/25">
          ...
          <div className="p-3 rounded-2xl border-2 border-dashed border-orange-200 bg-orange-50/60 flex items-center justify-between">
            <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-bold text-orange-700 bg-orange-100/80 px-2.5 py-0.5 rounded-full">
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                  selectedPlan === 'yearly' ? 'border-orange-500' : 'border-slate-300'
                }`}>
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                  selectedPlan === 'monthly' ? 'border-orange-500' : 'border-slate-300'
                }`}>
              ...
              <div className="space-y-2 pt-1">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold uppercase text-slate-900 focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                  <button
                    type="button"
          ...
          <div className="pt-1">
            <button
              ...
              disabled={isSuccess}
              className="w-full py-4 px-6 bg-orange-500 hover:bg-orange-600 text-white font-extrabold rounded-2xl shadow-xl shadow-orange-500/25 flex items-center justify-center gap-2 transition-all transform active:scale-[0.99] text-sm"
            >
              {isSuccess ? (
                <>
